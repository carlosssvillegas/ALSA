                ...
                <div class="col s12 " >
                  <div class="row">
                    ...
                    <select>
                          ...
                          <optgroup label="PRT (N1,N2)">
                              <option value="PRTN1">PRTN1</option>
                              <option value="PRTN2">PRTN2</option>
                          </optgroup>
                          </select>
                      </div>
                    </div>
    ...
    <div class="responsive-table">
      <table class="table centered">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <a class="modal-trigger small material-icons  green-text editbtn" href="editar_fertirriego.php">border_color</a>
              <a class="modal-trigger small material-icons  green-text editbtn" href="captura_fertirriego.php">add_circle</a>
              <a class="modal-trigger small material-icons  green-text editbtn" href="vista_fertirriego.php">more_horiz</a>
            </td> 
