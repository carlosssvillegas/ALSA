      ...
      <div class="nav-wrapper teal #ffffff white">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down"> 
          <li>    
           ...
           <li><a class="modal-trigger black-text">Nueva Semana</a></li>  
           <li><a class="modal-trigger black-text" href="#modal7">Importar Reloj</a></li> 
...
<!-- Modal Otros Ingresos -->
 <div id="modal2" class="modal" style="width: 55%; height: 50%;">
  <div class="modal-content">
...
<!-- Modal Descuentos -->
<div id="modal3" class="modal" style="width: 55%; height: 60%;">
  <div class="modal-content">
...
<div id="modal4" class="modal" style="width: 40%; height: 55%;">
  <div class="modal-content">
            ...
            <div class="row">
              <form class="col s12">
                <div class="row">
                  ...
                  <div class="input-field col s2">
                    <label for="">16</label>
                    <input id="11" type="number" class="validate">
                  </div>
                  <div class="input-field col s2">
                    <label for="">17</label>
                    <input id="12" type="number" class="validate">
                  </div>
                  <div class="input-field col s2">
                    <label for="">18</label>
                    <input id="13" type="number" class="validate">
                  </div>
                  <div class="input-field col s2">
                    <label for="">19</label>
            ...
            <div class="row">
              <form class="col s12">
                <div class="row">
                  ...
                  <div class="input-field col s2">
                    <label for="">16</label>
                    <input id="15" type="number" class="validate">
                  </div>
                  <div class="input-field col s2">
                    <label for="">17</label>
            ...
            <div class="row">
              <form class="col s12">
                <div class="row">
                  ...
                  <div class="input-field col s2">
                    <label for="">09</label>
                    <input id="22" type="number" class="validate">
                  </div>
                </div>
              </form>
            </div>
            <div class="row">
              <form class="col s12">
                <div class="row">
                  ...
                  <div class="input-field col s2">
                    <label for="">08</label>
                    <input id="25" type="number" class="validate">
                  </div>
                  <div class="input-field col s2">
                    <label for="">09</label>
                    <input id="26" type="number" class="validate">
                  </div>
                </div>
              </form>
            </div> 
              ...
              <div class="row">
                <form class="col s12">
                  <div class="row">
                    ...
                    <div class="input-field col s2">
                      <label for="">20</label>
                      <input id="27" type="number" class="validate">
                    </div>
                    <div class="input-field col s2">
                      <label for="">21</label>
                      <input id="28" type="number" class="validate">
                    </div>
                    <div class="input-field col s2">
                      <label for="">22</label>
                      <input id="29" type="number" class="validate">
                    </div>
                    <div class="input-field col s2">
                      <label for="">24</label>
                      <input id="30" type="number" class="validate">
                    </div>
                  </div>
                </form>
              </div>
              <div class="row">
                <form class="col s12">
                  <div class="row">
                    ...
                    <div class="input-field col s2">
                      <label for="">20</label>
                      <input id="31" type="number" class="validate">
                    </div>
                    <div class="input-field col s2">
                      <label for="">21</label>
                      <input id="32" type="number" class="validate">
                    </div>
                    <div class="input-field col s2">
                      <label for="">22</label>
                      <input id="33" type="number" class="validate">
                    </div>
                    <div class="input-field col s2">
                      <label for="">24</label>
                      <input id="34" type="number" class="validate">
                    </div>
                  </div>
                </form>
              </div> 
              ...
              <div class="row">
                <form class="col s12">
                  <div class="row">
                    ...
                    <div class="input-field col s4">
                      <label for="">10</label>
                      <input id="35" type="number" class="validate">
                    </div>
                  </div>
                </form>
              </div>
              <div class="row">
                <form class="col s12">
                  <div class="row">
                    ...
                    <div class="input-field col s4">
                      <label for="">10</label>
                      <input id="36" type="number" class="validate">
                    </div>
                  </div>
                </form>
              </div> 
                ...
                <div class="row">
                  <form class="col s12">
                    <div class="row">
                      ...
                      <div class="input-field col s4">
                        <label for="">14</label>
                        <input id="37" type="number" class="validate">
                      </div>
                    </div>
                  </form>
                </div>
                <div class="row">
                  <form class="col s12">
                    <div class="row">
                      ...
                      <div class="input-field col s4">
                        <label for="">14</label>
                        <input id="38" type="number" class="validate">
                      </div>
                    </div>
                  </form>
                </div> 
...
<!--Modal Importar relog-->
<div id="modal7" class="modal" style="width: 40%; height: 50%;">
  <div class="modal-content">
   ...
   <form action="../controller/import.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="center">
    <input id="btn_lectura" type="submit" value="Subir" class="modal-close green accent-4 waves-light btn"></input>
  </div>
  </form>
   ...
   <div class="row">
    ...
    <table class="centered responsive-table">
      ...
      <tbody>
        <tr>
          <td>
            <a class="small material-icons left green-text">border_color</a>
            <a class="small material-icons right red-text ">delete</a>
          </td>
          <td>1</td>
          <td>2149</td>
          <td>P2B04</td>
