    ...
    <div class="responsive-table">
      <table class="table centered">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <a class="modal-trigger small material-icons  green-text editbtn" href="editar_viñedo.php">border_color</a>
              <a class="modal-trigger small material-icons  green-text editbtn" href="captura_viñedo.php">add_circle</a>
              <a class="modal-trigger small material-icons  green-text editbtn" href="vista_viñedo.php">more_horiz</a>
            </td> 
