...
if(isset($_POST)){
    ...
    //sesion start
    session_start();
    //Recoger los valores del formulario de registro empleados
   ...
   // validar la direccion
    ...
    if(count($errores) == 0){
        ...
        // INSERTAR EMPLEADO EN LA TABLA DE EMPLEADOS DE LA BBDD
        $sql = "INSERT INTO tb_empleados value (null, '$numero_de_nomina' , '$nombre', '$codigo', '$departamento', '$puesto',
       '$area', '$estatus', '$direccion', '$localidad', '$municipio', '$cp', '$estado', '$fecha_alta', '$nss', '$curp',
       '$rfc', '$fecha_nacimiento', '$sexo', '$transporte', '$locker_asignado', '$numero_uniforme', '$color', '$talla')";
        ...
        if($conexion) {
            ...
            $_SESSION['errores']['general'] = "Fallo al guardar el empleado!!";
        }
...
header('Location: ../views/Rh_registro.php');